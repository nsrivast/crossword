#!/usr/bin/env python
# model_real.py
# builds clue-solving model data from corpus of real NYTimes xwords
# tags: 
# functions:
#   build_clues_csv(puz_filenames, csv_filename)
#   load_clues_from_csv(csv_filename)
#   run_model_random(num_turns, word_lengths, num_filled, save_path)
#   run_model_played(load_path, save_path)

import random
import time
import csv

def build_clues_csv(puz_filenames, csv_filename):
    with open("xwords/clues.txt", "rU") as f:
